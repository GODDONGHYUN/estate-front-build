...
export default function Ratio() {
  ...
  //                    function                    //
  const getRatioDataResponse = (
    result: GetRatioDataResponseDto | ResponseDto | null
  ) => {
  ...
  const onSearchClickHandler = () => {
    ...
    getRatioDataRequest(selectLocal, cookies.accessToken).then(
      getRatioDataResponse
    );
  };
  ...
  const leaseRatioFlag =
    !!leaseRatio40.length &&
    !!leaseRatio4060.length &&
    !!leaseRatio6085.length &&
    !!leaseRatio85.length;
  const monthRentRatioFlag =
    !!monthRentRatio40.length &&
    !!monthRentRatio4060.length &&
    !!monthRentRatio6085.length &&
    !!monthRentRatio85.length;
        ...
        <div className="local-card">
          ...
          <div className="local-card-chart-box">
            <Line
              width={"1086px"}
              height={"238px"}
              options={monthRentRatioOptions}
              data={monthRentRatioData}
            />
          </div>
        </div>
      )}
