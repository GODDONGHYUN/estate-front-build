...
export default function Local() {
  ...
  //                    function                    //
  const getLocalDataResponse = (
    result: GetLocalDataResponseDto | ResponseDto | null
  ) => {
    ...
    const { yearMonth, sale, lease, monthRent } =
      result as GetLocalDataResponseDto;
  ...
  const onSearchClickHandler = () => {
    ...
    getLocalDataRequest(selectLocal, cookies.accessToken).then(
      getLocalDataResponse
    );
  };
